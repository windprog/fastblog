...
class PostsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('高级选项', {
            'classes': ('collapse',),
            'fields': (
                'post_date', 'post_date_gmt', 'post_excerpt', 'comment_status', 'ping_status', 'post_password',
                'post_name')
        }),
        ('其他选项', {
            'classes': ('collapse',),
...
class CommentsAdmin(admin.ModelAdmin):
    list_display = (
        'comment_post_post_title', 'comment_content_more', 'comment_author', 'comment_approved', 'comment_date')
...
class LinksAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('其他选项', {
            'classes': ('collapse',),
            'fields': (
            'link_image', 'link_target', 'link_description', 'link_owner', 'link_rating', 'link_updated', 'link_rel',
            'link_notes', 'link_rss')
        }),
    )
